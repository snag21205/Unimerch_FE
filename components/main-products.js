...
(function () {
  ...
  // ===== MODERN PRODUCT CARD COMPONENT - REDESIGNED (FIXED IMAGE FILL) =====
    ...
    return `
      ...
      ">
        ...
        <div class="position-relative overflow-hidden" style="
          background: #e3f2fd;
          height: 280px;
          padding: 0;                          /* FIX: bỏ padding để ảnh full-width */
        ...
        ">
          ...
          <img src="${product.image_url}" alt="${product.name}"
            style="
              position: absolute;              /* FIX: phủ toàn khung */
              inset: 0;
              width: 100%;
              height: 100%;
              object-fit: cover;               /* FIX: fill + crop */
        ...
        ${product.status === 'out_of_stock' ? `
          ...
          ">
            <div class="text-center">
              <div class="badge bg-white text-dark px-4 py-2 rounded-pill" style="font-size: 0.9rem; border: 1px solid #e5e7eb; font-weight: 600;">
                Out of Stock
              </div>
              <p class="text-muted " style="font-size: 0.8rem;">Notify when available</p>
            </div>
          </div>
        ` : ''}
      </div>
